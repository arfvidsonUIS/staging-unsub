...
struct spar_keyboard_channel_protocol {
	...
	struct ultra_inputreport input_report[KEYBOARD_MAXINPUTREPORTS];
};
...
static inline void
spar_keyboard_init_channel(struct spar_keyboard_channel_protocol *x)
{
	...
	spar_signal_init(x, input_report_q, input_report,
			 struct ultra_inputreport, 0, 0);
