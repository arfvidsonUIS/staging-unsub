...
static void chipset_bus_create(unsigned long bus_no);
static void chipset_bus_destroy(unsigned long bus_no);
static void chipset_device_create(unsigned long bus_no, unsigned long dev_no);
static void chipset_device_destroy(unsigned long bus_no, unsigned long dev_no);
static void chipset_device_pause(unsigned long bus_no, unsigned long dev_no);
static void chipset_device_resume(unsigned long bus_no, unsigned long dev_no);
static int chipset_get_channel_info(uuid_le type_guid, unsigned long *min_size,
...
static void
chipset_bus_create(unsigned long bus_no)
{
	struct visorchipset_bus_info bus_info;
...
static void
chipset_bus_destroy(unsigned long bus_no)
{
	struct visorchipset_bus_info bus_info;
	struct visorbus_devdata *devdata;
	int rc = -1;
...
static void
chipset_device_create(unsigned long bus_no, unsigned long dev_no)
{
...
static void
chipset_device_destroy(unsigned long bus_no, unsigned long dev_no)
{
	struct visorchipset_device_info dev_info;
	struct visor_device *dev;
	int rc = -1;
 ...
 */
static void
initiate_chipset_device_pause_resume(unsigned long bus_no, unsigned long dev_no,
				     bool is_pause)
{
	struct visorchipset_device_info dev_info;
	struct visor_device *dev = NULL;
	...
	void (*notify_func)(unsigned long bus_no, unsigned long dev_no,
			    int response) = NULL;
...
static void
chipset_device_pause(unsigned long bus_no, unsigned long dev_no)
{
	initiate_chipset_device_pause_resume(bus_no, dev_no, TRUE);
}

static void
chipset_device_resume(unsigned long bus_no, unsigned long dev_no)
{
...
static int
chipset_get_channel_info(uuid_le type_guid, unsigned long *min_size,
			 unsigned long *max_size)
{
